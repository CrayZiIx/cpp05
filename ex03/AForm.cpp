...
/*   Updated: 2024/03/31 17:09:58 by jolecomt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "AForm.hpp"

AForm::AForm(void) : _name("Basic Formular"), _gradeSigne(100), _gradeExec(100), _isSigned(false)
{
...
{
    return ("This form can't be execute, he is not signed !");
}
